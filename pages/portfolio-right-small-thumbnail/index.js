...
const topBanner =
{
    ...
    title: 'Portfolio Right Small Thumbnail',
}
export default function Cases_portfolio_rightsmall_thumbnail(props) {
...
Cases_portfolio_rightsmall_thumbnail.getLayout = function getLayout(page) {

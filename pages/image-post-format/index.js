...
import ImagePostFormatBlk from '../../blocks/ImagePostFormatBlk/imagePostFormatBlk'
...
export default function ImagePostFormat(props) {
...
ImagePostFormat.getLayout = function getLayout(page) {

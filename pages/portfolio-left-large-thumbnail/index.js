...
const topBanner =
{
  ...
  title: 'Portfolio Left Large Thumbnail',
}
export default function Cases_portfolio_leftlarge_thumbnail(props) {
...
Cases_portfolio_leftlarge_thumbnail.getLayout = function getLayout(page) {

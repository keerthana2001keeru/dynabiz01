...
const topBanner =
{
    ...
    title: 'Portfolio Left Right Small Thumbnail',
}
export default function Cases_portfolio_left_right_small_thumbnail(props) {
...
Cases_portfolio_left_right_small_thumbnail.getLayout = function getLayout(page) {

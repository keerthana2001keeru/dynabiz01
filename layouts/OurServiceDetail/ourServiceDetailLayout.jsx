...
import styles from "./ourServiceDetail.module.scss";
...
export default function OurServiceDetailLayout(props) {
 // console.log("gg",props?.uiSettings?.TH00025P01?.blocks)
  //console.log(props?.uiSettings?.TH00025P20?.blocks?.TH00025B73?.elements?.FavIconandText?.favicon?.value);
  return (
    <div>
     <ContactTopBanner
        uiSettings={props?.uiSettings?.TH00025P01?.blocks?.TH00025B73}
      /> 

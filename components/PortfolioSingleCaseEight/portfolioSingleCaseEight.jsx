...
import styles from './portfolioSingleCaseEight.module.scss'

export default function PortfolioSingleCaseEight() {
    return (
        <div className='container-fluid'>
            <div className="row">
                <div className="col-12 col-md-6 text-center">
                    <img className={'img-fluid ' + styles.imgs} src="/uploads/single-port-1.jpg" alt="" />
                </div>

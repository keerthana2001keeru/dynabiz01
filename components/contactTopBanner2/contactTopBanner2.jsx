...
export default function ContactTopBanner2(props) {
  let HomeOneValue = {};
  ...
  return (
    <div className="container-fluid p-0">
      ...
      >
        ...
        //   style={{
        //     backgroundImage:url("https://skartiocloud.sgp1.digitaloceanspaces.com/SKARTIO/THEME/1676971567460about-team-bg.jpg"),

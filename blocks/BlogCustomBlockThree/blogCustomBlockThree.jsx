...
import styles from './blogCustomBlockThree.module.scss'
...
const setImg = [
    {
        img: '/uploads/hands-coffee-smartphone-technology.jpg'
    },
    {
        img: '/uploads/shutterstock_417862237.jpg'
    },
    {
        img: '/uploads/shutterstock_519924262.jpg'
    }
]
export default function BlogCustomBlockThree() {
    return (
        <div>
            <div className={styles.coustomStyle}>
                <LeftAlignParagraph setCmp={setdata} />
                <div className={styles.imgSection}>
                    <div className='row'>
                        {setImg?.map((item, index) => {
                            return (
                                <div className='col-12 col-md-4 p-2'><SingleImage setCmp={item} /></div>
                            )
                        })}
                    </div>
                </div>
